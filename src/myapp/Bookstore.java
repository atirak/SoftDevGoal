...
public class Bookstore extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelBook.add(img_showbook, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 60, 280, 370));
        ...
        btn_selectCounts.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                btn_selectCountsAncestorAdded(evt);
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
            }
        });
        panelBook.add(btn_selectCounts, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 110, 40));
        ...
        panelBook.add(btn_pick, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 390, 160, 40));

        lbl_bookname.setFont(new java.awt.Font("Ekkamai Standard", 1, 18)); // NOI18N
        panelBook.add(lbl_bookname, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 400, 60));

        lbl_authorname.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_authorname, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 360, 60));

        lbl_booktype.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_booktype, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 360, 60));

        lbl_bookprice.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_bookprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 360, 70));

        lbl_bookpublisher.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_bookpublisher, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 360, 70));

        lbl_bookyears.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_bookyears, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 230, 360, 70));

        lbl_booklanguage.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_booklanguage, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 260, 360, 70));

        lbl_bookpagenumber.setFont(new java.awt.Font("Ekkamai Standard", 0, 16)); // NOI18N
        panelBook.add(lbl_bookpagenumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 360, 70));

        lbl_showdetail.setBackground(new java.awt.Color(233, 233, 255));
        panelBook.add(lbl_showdetail, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 460, 320));
        ...
        panelMenu.add(btn_userStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 10, 240, 40));
        ...
        btn_loginStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_loginStatusActionPerformed(evt);
            }
        });
        btn_menubar.add(btn_loginStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 0, 120, 40));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(panelBook, javax.swing.GroupLayout.PREFERRED_SIZE, 1050, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(panelMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 1050, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(panelBook, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btn_selectCountsAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_btn_selectCountsAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_btn_selectCountsAncestorAdded
    ...
    private void btn_loginStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginStatusActionPerformed
        if(id_user==0){
            setAllVisibleFalse();
            panelLogin.setVisible(true);
        }else{
            ...
            panelHome.setVisible(true);
            checkUserAndSet();
            btn_loginStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/java/myapp/images/Name_26px.png")));

        }
        jTextField15.setText(null);
        jTextField16.setText(null);
    }//GEN-LAST:event_btn_loginStatusActionPerformed
    ...
    private void btn_search_iconActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_search_iconActionPerformed
        ...
        search.put("name_Book",btn_search.getText());
        if(setBook(search)){
            lbl_bookname.setText("ไม่พบหนังสือ");
            lbl_authorname.setText(null);
            lbl_booktype.setText(null);
            lbl_bookprice.setText(null);
            lbl_bookpublisher.setText(null);
            lbl_bookyears.setText(null);
            lbl_booklanguage.setText(null);
            lbl_bookpagenumber.setText(null);
            img_showbook.setIcon(null);
            btn_selectCounts.setVisible(false);
            btn_pick.setVisible(false);
        }
